...
const TagCard = ({ number, title, text, className, aosDelay, aosType, pathLength, containerRef }) => {
  ...
  return (
    <div 
      ...
      style={isActive
        ? {background: '#1a6fff', border: '1px solid #4d94ff', boxShadow: '0 20px 50px rgba(26,111,255,0.35)'}
        : {background: 'white', border: '1px solid #e5e7eb', boxShadow: '0 15px 40px rgba(0,0,0,0.06)'}
      }
    >
      {/* The hole punch */}
      ...
      <div className="max-w-6xl mx-auto relative md:h-[1350px]">
        ...
        <div data-aos="fade-up" className="md:absolute top-10 left-0 md:w-[450px] z-20 mb-16 md:mb-0">
          ...
          <h2 className="text-4xl md:text-5xl lg:text-6xl font-black text-gray-900 leading-[1.1] mb-6 tracking-tight relative">
            Here's how I build things that actually work
          </h2>
          <p className="text-gray-500 text-base md:text-lg max-w-sm font-medium leading-relaxed">
            From concept to deployment — I follow a structured, creative, and technically rigorous process to turn your vision into reality.
          </p>
        </div>
        ...
        <div className="flex flex-col gap-8 md:gap-12 items-center md:block relative z-10 w-full pt-4 md:pt-0 pb-12 md:pb-0">
          ...
          <TagCard 
            number="01"
            title="Discover"
            text="I start by understanding your goals, your users, and your constraints — so every decision is backed by clarity, not guesswork."
          ...
          <TagCard 
            number="02"
            title="Design"
            text="Creating modern, responsive UI/UX — clean interfaces that look great and convert. From wireframes to pixel-perfect screens."
          ...
          <TagCard 
            number="03"
            title="Build"
            text="Developing full-stack solutions with React, Python, and Node.js — plus AR experiences in Snap Lens Studio and AI-powered features."
          ...
          <TagCard 
            number="04"
            title="Launch"
            text="Thorough testing, performance optimization, and deployment — followed by ongoing support to ensure everything runs smoothly."
